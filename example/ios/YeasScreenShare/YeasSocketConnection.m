...
@interface YeasSocketConnection () <NSStreamDelegate>
...
@implementation YeasSocketConnection{
    int _socket;
...
@implementation YeasSocketConnection (NSStreamDelegate)
