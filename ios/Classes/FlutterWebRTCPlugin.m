...
#endif
    } else if ([call.method isEqualToString:@"getScreenMedia"]) {
#pragma mark 屏幕共享（iOS12以后的）
        NSDictionary* argsMap = call.arguments;
        NSDictionary* constraints = argsMap[@"constraints"];
...
#pragma mark 先初始化一个texture渲染，获取的视频源通过代理在这个里面渲染
